...
export const MULTICALL_ADDRESS: { [key in ChainId]?: Address } = {
  ...
  [ChainId.CRONOS_ZKEVM]: '0x9b122BF7a96F24EFB7A2b5765c635909dB3458F7',
  ...
  // Testnets
  [ChainId.CRONOS_TESTNET]: '0x78eB7e96Abe54802B4eabCaD57B90Fe3Bc2b95b7',
...
export const MULTICALL3_ADDRESSES: {
  ...
  [ChainId.CRONOS]: MULTICALL3_ADDRESS,
  [ChainId.CRONOS_TESTNET]: MULTICALL3_ADDRESS,
