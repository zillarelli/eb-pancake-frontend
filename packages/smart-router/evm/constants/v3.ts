...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.CRONOS]: TICK_LENS_MAINNET_ADDRESS,
  [ChainId.CRONOS_TESTNET]: TICK_LENS_TESTNET_ADDRESS,
  [ChainId.CRONOS_ZKEVM]: TICK_LENS_TESTNET_ADDRESS,
  [ChainId.CRONOS_ZKEVM_TESTNET]: TICK_LENS_TESTNET_ADDRESS,
