...
export const POOL_INIT_CODE_HASHES = {
  ...
  [ChainId.CRONOS]: POOL_INIT_CODE_HASH,
  [ChainId.CRONOS_TESTNET]: POOL_INIT_CODE_HASH,
  [ChainId.CRONOS_ZKEVM]: POOL_INIT_CODE_HASH,
  [ChainId.CRONOS_ZKEVM_TESTNET]: POOL_INIT_CODE_HASH,
